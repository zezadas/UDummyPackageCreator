...
public class SpecFileOperator {
	 ...
	 * 	@return			The DummyPackage object that represents the Dummy Package base and loaded information
	 */
	private static DummyPackage loadAndCreate(File specfile){
	...
	public DummyPackage openSpecFile(File specfile) {
		DummyPackage e = loadAndCreate(specfile);
		this.setStatus(true);
		return e;
	}
	...
	public DummyPackage createDefaultSpecFile(File specfile) {
		...
		return this.openSpecFile(specfile);
	}
	
	/*	
	 *  This function opens a text editor to edit the given file. The chosen text editor is VIM.
	 *  @param			The File Object that represents the spec file
	 */
